...
\hardsubproblem{Compare $\thetahat_{\text{bad}}$ to $\Xbar$ using the sup risk with squared error loss. How much better is $\Xbar$? With $n$ getting larger does it get better?}\spc{3}
